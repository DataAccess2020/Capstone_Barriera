...
Explicit_PR = subset(Explicit_PR, select = -c(track_name, album_release_year))
Explicit_MD = subset(Explicit_MD, select = -c(track_name, album_release_year))
Explicit_PB = subset(Explicit_PB, select = -c(track_name, album_release_year))
Explicit_DR = subset(Explicit_DR, select = -c(track_name, album_release_year))
